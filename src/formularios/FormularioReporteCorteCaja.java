...
import operacionesCaja.ReporteCorteCaja;
 ...
 * @author FRANCO
 */
public class FormularioReporteCorteCaja extends javax.swing.JDialog {

    private ReporteCorteCaja reporteCorteCaja;
    private PrincipalCaja principalCaja;

    public FormularioReporteCorteCaja(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
    }

    public ReporteCorteCaja getReporteCorteCaja() {
        return reporteCorteCaja;
    }

    public void setReporteCorteCaja(ReporteCorteCaja reporteCorteCaja) {
        this.reporteCorteCaja = reporteCorteCaja;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BUSCAR CORTES DE CAJA");
        ...
        tablaGrafica.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "TOTAL VENTAS", "TOTAL GASTOS", "BALANCE", "FECHA"
            }
        ) {
                        ...
                        .addGroup(PanelIngresoMateriaPrimaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, PanelIngresoMateriaPrimaLayout.createSequentialGroup()
                                .addGroup(PanelIngresoMateriaPrimaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(radBtnAbrirDocumento, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE))
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        reporteCorteCaja.ejecutarBusqueda();
    }//GEN-LAST:event_btnBuscarActionPerformed

    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        try {
            reporteCorteCaja.ejecutarGenerarReportes();
        } catch (FileNotFoundException ex) {
            Logger.getLogger(FormularioReporteCorteCaja.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioReporteCorteCaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormularioReporteCorteCaja dialog = new FormularioReporteCorteCaja(new javax.swing.JFrame(), true);
